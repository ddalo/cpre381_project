...
test_framework_path = r'internal\testpy\test_framework.py'
...
def main():
    ...
    if custom_path_found == False:
        ...
        #If either the VDI or LAB computer paths are correct, then it runs synthesis_framework.py
        if VDI_Path_Check == True or LAB_Path_Check == True:
            ...
            subprocess.Popen([python_path,str(synthesis_framework_path)])
